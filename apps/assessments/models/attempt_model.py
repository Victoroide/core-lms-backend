...
class QuizAttempt(models.Model):
    ...
    Note: Multiple attempts per (student, quiz) are allowed by design. A
    student may retake a quiz to improve their score and trigger an updated
    adaptive study plan. No unique_together constraint is imposed.
    """
    ...
    adaptive_plan = models.JSONField(null=True, blank=True)
